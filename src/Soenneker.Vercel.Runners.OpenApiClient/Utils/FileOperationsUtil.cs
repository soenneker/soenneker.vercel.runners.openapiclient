...
using Soenneker.Vercel.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Vercel.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        await _kiotaUtil.Generate(fixedFilePath, "VercelOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
